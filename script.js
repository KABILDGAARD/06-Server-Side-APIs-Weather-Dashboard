...
function success(position) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=1138ad5f16fc353846b2474410288ba2";
    $.ajax({
        url: queryURL,
        method: "GET"
...
function getCurrent(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=1138ad5f16fc353846b2474410288ba2&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET",
        error: function () {
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=1138ad5f16fc353846b2474410288ba2&lat=" + response.coord.lat + "&lon=" + response.coord.lat;
        $.ajax({
            url: uvURL,
            method: "GET"
...
function getForecast(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&APPID=1138ad5f16fc353846b2474410288ba2&units=imperial";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
        var newrow = $("<div>").attr("class", "forecast");
        $("#globeforecast").append(newrow);
